...
export default function Create() {
    ...
    function btnSaveClick(){
        ...
        addCampaign(campaign)
            ...
            .then(id => setMessage(`Campanha foi salva com o ID ${id}. Em alguns segundos/minutos ela estará pronta para receber doações, 
                use esse link para divulgá-la: http://localhost:3000/planta/${id}`))
            .catch(err => {
                console.log(err);
    ...
    return (
      <>
        <div className="container">
            <h1 className="display-5 fw-bold text-body-emphasis lh-1 mb-3 mt-5">Planta Crypto</h1>
